# Author: Prem Kumar.V
# Date: May 05, 2026
# Description: Club Section Team Configuration History Notes feature test scenarios

@clubSectionTeamConfigurationHistoryNotes 
Feature: Club Section Team Configuration history Notes functionality
    As a user
    ...
    Background:
        ...
        Then click on team name as "CAT Club123 A"
