...
@clubSectionTeamHistoryNotes 
Feature: Club Section Team history Notes functionality
    As a user
    ...
    Background:
        ...
        Then User clicks the Teams tab in club section
        Then User clicks on "YY" suffix in club section team list
        Then click on the "History" tab
        Then click on team name as "Meet1"
