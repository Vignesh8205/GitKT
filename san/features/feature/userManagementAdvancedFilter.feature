@smoke @regression @userManagementAdvancedFilter @advanceFilter
Feature: User Management Advanced Filter Functionality
    As a user
    I want to filter the User Management grid using advanced filter criteria
    So that I can find specific users using complex conditions
    ...
    @userManagementAdvancedFilterSingleConditionTest
    Scenario Outline: Verify user can apply a single condition filter using <Field> <Operator> "<Value>"
        ...
        Then  User clicks the Settings tab
        Then  User clicks the User Management tab
        Then  User verifies the User Management page title
        ...
        Then  User starts capturing the user management advanced filter list API response
        Then  User clicks the Apply Advanced Filter button
        Then  User verifies the user management advanced filter API response total count is greater than zero
        Then  User prints the user management advanced filter API response JSON
        Then  User verifies all user management advanced filter API records have "<Field>" "<Operator>" "<Value>"
    ...
    @userManagementAdvancedFilterANDConditionTest
    Scenario Outline: Verify user can apply two conditions with AND logic - <Field1> and <Field2>
        ...
        Then  User verifies the user management advanced filter API response total count is greater than zero
        Then  User prints the user management advanced filter API response JSON
        Then  User verifies all user management advanced filter API records have "<Field1>" "<Operator1>" "<Value1>"
        Then  User verifies all user management advanced filter API records have "<Field2>" "<Operator2>" "<Value2>"
        ...
        Examples:
            ...
            | First Name   | Contains  | user   | Status |  Contains        | Active |

    # =========================================================
    # ADVANCED FILTER – OR OPERATORS
    # =========================================================

    @userManagementAdvancedFilterORConditionTest
    Scenario Outline: Verify user can apply two conditions with OR logic - <Field1> or <Field2>
        ...
        Then  User verifies the user management advanced filter API response total count is greater than zero
        Then  User prints the user management advanced filter API response JSON
        Then  User verifies all user management advanced filter API records satisfy "<Field1>" "<Operator1>" "<Value1>" or "<Field2>" "<Operator2>" "<Value2>"
        ...
        Examples:
            | Field1       | Operator1 | Value1 | Field2 | Operator2        | Value2   |
            | First Name   | Contains  | user   | Email  | Starts with      | test     |

    # =========================================================
    # ADVANCED FILTER – IN OPERATOR
    # =========================================================

    @userManagementAdvancedFilterInOperatorTest
    Scenario Outline: Verify user can apply a single condition filter using <Field> In "<Value>"
        ...
        Then  User verifies the user management advanced filter API response total count is greater than zero
        Then  User prints the user management advanced filter API response JSON
        Then  User verifies all user management advanced filter API records have "<Field>" "In" "<Value>"
    ...
    @userManagementAdvancedFilterNotInOperatorTest
    Scenario Outline: Verify user can apply a single condition filter using <Field> Not in "<Value>"
        ...
        Then  User verifies the user management advanced filter API response total count is greater than zero
        Then  User prints the user management advanced filter API response JSON
        Then  User verifies all user management advanced filter API records have "<Field>" "Not in" "<Value>"
    ...
    @userManagementAdvancedFilterEqualOperatorTest
    Scenario Outline: Verify user can apply a single condition filter using <Field> <Operator> "<Value>"
        # Navigate to Settings > User Management
        Then  User Can able to access the Main menu in home page
        Then  User clicks the Settings tab
    ...
    @userManagementAdvancedFilterCombinedNotInTest
    Scenario Outline: Verify user can combine Contains and Not in conditions with AND logic
        ...
        Then  User verifies the user management advanced filter API response total count is greater than zero
        Then  User prints the user management advanced filter API response JSON
        Then  User verifies all user management advanced filter API records satisfy "<Field1>" "<Operator1>" "<Value1>" and "<Field2>" "Not in" "<Value2>"
        ...
        Examples:
            ...
            | First Name   | Contains  | user   | Status |  Inactive |