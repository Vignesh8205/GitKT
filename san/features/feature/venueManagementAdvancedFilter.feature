@smoke @regression @venueManagementAdvancedFilter @advanceFilter
Feature: Venue Management Advanced Filter Functionality
    As a user
    I want to filter the Venue Management grid using advanced filter criteria
    So that I can find specific venues using complex conditions
    ...
    @venueManagementAdvancedFilterSingleConditionTest
    Scenario Outline: Verify user can apply a single condition filter using <Field> <Operator> "<Value>"
        # Navigate to Resource Management > Venue Management
        ...
        Then  User verifies the Venue Management page title

        # Open filter dialog and switch to Advanced Filter tab
        Then  User clicks the Home tab in Venue Management
        ...
        Then  User starts capturing the venue management advanced filter list API response
        Then  User clicks the Apply Advanced Filter button
        Then  User verifies the venue management advanced filter API response total count is greater than zero
        Then  User prints the venue management advanced filter API response JSON
        Then  User verifies all venue management advanced filter API records have "<Field>" "<Operator>" "<Value>"
    ...
    @venueManagementAdvancedFilterANDConditionTest
    Scenario Outline: Verify user can apply two conditions with AND logic - <Field1> and <Field2>
        ...
        Then  User verifies the venue management advanced filter API response total count is greater than zero
        Then  User prints the venue management advanced filter API response JSON
        Then  User verifies all venue management advanced filter API records have "<Field1>" "<Operator1>" "<Value1>"
        ...
        Examples:
            ...
            | Name   | Contains  | Venue  | Status | Does not contain | Inactive |

    # =========================================================
    # ADVANCED FILTER – OR OPERATORS
    # =========================================================

    @venueManagementAdvancedFilterORConditionTest
    Scenario Outline: Verify user can apply two conditions with OR logic - <Field1> or <Field2>
        ...
        Then  User verifies the venue management advanced filter API response total count is greater than zero
        Then  User prints the venue management advanced filter API response JSON
        Then  User verifies all venue management advanced filter API records satisfy "<Field1>" "<Operator1>" "<Value1>" or "<Field2>" "<Operator2>" "<Value2>"
        ...
        Examples:
            | Field1 | Operator1 | Value1 | Field2       | Operator2   | Value2 |
            | Name   | Contains  | Venue  | Surface Type | Starts with | Grass  |

    # =========================================================
    # ADVANCED FILTER – IN OPERATOR
    # =========================================================

    @venueManagementAdvancedFilterInOperatorTest
    Scenario Outline: Verify user can apply a single condition filter using <Field> In "<Value>"
        ...
        Then  User verifies the venue management advanced filter API response total count is greater than zero
        Then  User prints the venue management advanced filter API response JSON
        Then  User verifies all venue management advanced filter API records have "<Field>" "In" "<Value>"
    ...
    @venueManagementAdvancedFilterNotInOperatorTest
    Scenario Outline: Verify user can apply a single condition filter using <Field> Not in "<Value>"
        ...
        Then  User verifies the venue management advanced filter API response total count is greater than zero
        Then  User prints the venue management advanced filter API response JSON
        Then  User verifies all venue management advanced filter API records have "<Field>" "Not in" "<Value>"
    ...
    @venueManagementAdvancedFilterEqualOperatorTest
    Scenario Outline: Verify user can apply a single condition filter using <Field> <Operator> "<Value>"
        # Navigate to Resource Management > Venue Management
        Then  User Can able to access the Main menu in home page
        Then  User navigates to "Resource Management" from main menu
        ...
        Examples:
            | Field  | Operator  | Value            |
            | Name   | Equal     | RegressioVenue24 |
            | Name   | Not equal | RegressioVenue24 |

    # =========================================================
    # ADVANCED FILTER – COMBINED: Contains AND Not in
    # =========================================================

    @venueManagementAdvancedFilterCombinedNotInTest
    Scenario Outline: Verify user can combine Contains and Not in conditions with AND logic
        ...
        Then  User verifies the venue management advanced filter API response total count is greater than zero
        Then  User prints the venue management advanced filter API response JSON
        Then  User verifies all venue management advanced filter API records satisfy "<Field1>" "<Operator1>" "<Value1>" and "<Field2>" "Not in" "<Value2>"
        ...
        Examples:
            ...
            | Name   | Contains  | Venue  | Status | Inactive |