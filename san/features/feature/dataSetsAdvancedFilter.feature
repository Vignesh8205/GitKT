@smoke @regression @dataSetsAdvancedFilter @advanceFilter
Feature: DataSets Advanced Filter Functionality
    As a user
    I want to filter the Data Sets grid using advanced filter criteria
    So that I can find specific datasets using complex conditions
    ...
    @dataSetsAdvancedFilterSingleConditionTest
    Scenario Outline: Verify user can apply a single condition filter using <Field> <Operator> "<Value>"
        # Navigate to Settings > Data Sets
        Then  User Can able to access the Main menu in home page
        Then  user choose "Settings"
        Then  User navigates to DataSets page
        Then  User clicks the Home tab in Data Sets
        Then  User verifies the Data Sets page title
        ...
        Then  User starts capturing the DataSets advanced filter list API response
        Then  User clicks the Apply Advanced Filter button
        Then  User verifies the DataSets advanced filter API response total count is greater than zero
        Then  User prints the DataSets advanced filter API response JSON
        Then  User verifies all DataSets advanced filter API records have "<Field>" "<Operator>" "<Value>"
    ...
    @dataSetsAdvancedFilterANDConditionTest
    Scenario Outline: Verify user can apply two conditions with AND logic - <Field1> and <Field2>
        ...
        Then  User verifies the DataSets advanced filter API response total count is greater than zero
        Then  User prints the DataSets advanced filter API response JSON
        Then  User verifies all DataSets advanced filter API records have "<Field1>" "<Operator1>" "<Value1>"
        Then  User verifies all DataSets advanced filter API records have "<Field2>" "<Operator2>" "<Value2>"
        ...
        Examples:
            ...
            | Dataset Name   | Contains  | Data   | Status | Does not contain | Active   |

    # =========================================================
    # ADVANCED FILTER – OR OPERATORS
    # =========================================================

    @dataSetsAdvancedFilterORConditionTest
    Scenario Outline: Verify user can apply two conditions with OR logic - <Field1> or <Field2>
        ...
        Then  User verifies the DataSets advanced filter API response total count is greater than zero
        Then  User prints the DataSets advanced filter API response JSON
        Then  User verifies all DataSets advanced filter API records satisfy "<Field1>" "<Operator1>" "<Value1>" or "<Field2>" "<Operator2>" "<Value2>"
        ...
        Examples:
            | Field1         | Operator1 | Value1 | Field2 | Operator2   | Value2   |
            | Dataset Name   | Contains  | Data   | Status | Starts with | Active   |

    # =========================================================
    # ADVANCED FILTER – IN OPERATOR
    # =========================================================

    @dataSetsAdvancedFilterInOperatorTest
    Scenario Outline: Verify user can apply a single condition filter using <Field> In "<Value>"
        ...
        Then  User verifies the DataSets advanced filter API response total count is greater than zero
        Then  User prints the DataSets advanced filter API response JSON
        Then  User verifies all DataSets advanced filter API records have "<Field>" "In" "<Value>"
    ...
    @dataSetsAdvancedFilterNotInOperatorTest
    Scenario Outline: Verify user can apply a single condition filter using <Field> Not in "<Value>"
        ...
        Then  User verifies the DataSets advanced filter API response total count is greater than zero
        Then  User prints the DataSets advanced filter API response JSON
        Then  User verifies all DataSets advanced filter API records have "<Field>" "Not in" "<Value>"
    ...
    @dataSetsAdvancedFilterEqualOperatorTest @Filterfix
    Scenario Outline: Verify user can apply a single condition filter using <Field> <Operator> "<Value>"
        # Navigate to Settings > Data Sets
        Then  User Can able to access the Main menu in home page
        Then  user choose "Settings"
        ...
        Examples:
            | Field         | Operator  | Value             |
            | Dataset Name  | Equal     | Competition Data  |
            | Dataset Name  | Not equal | Competition Data  |

    # =========================================================
    # ADVANCED FILTER – COMBINED: Contains AND Not in
    # =========================================================

    @dataSetsAdvancedFilterCombinedNotInTest @Filterfix 
    Scenario Outline: Verify user can combine Contains and Not in conditions with AND logic
        ...
        Then  User verifies the DataSets advanced filter API response total count is greater than zero
        Then  User prints the DataSets advanced filter API response JSON
        Then  User verifies all DataSets advanced filter API records satisfy "<Field1>" "<Operator1>" "<Value1>" and "<Field2>" "Not in" "<Value2>"
        ...
        Examples:
            ...
            | Dataset Name   | Contains  | Data   | Status | Inactive |
