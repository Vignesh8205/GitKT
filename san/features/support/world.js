...
const PageManager = require('../../pages/commonUtils/PageManager');
...
class CustomWorld extends World {
    constructor(options) {
        ...
        this.page = null;
        this.context = null;
        this.baseUrl = getEnv() ; // Using a reliable test URL
        this.headless = process.env.HEADED=="true"?true:false; // Default to headless mode as per user preference
        this.browserType = process.env.BrowserType; // Default to chromium (Chrome)
        this.loginPage = null; // Will be initialized in step definitions
        this.divisionPage = null;
        this.pages={}
    }
